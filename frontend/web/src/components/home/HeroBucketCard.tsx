...
export function HeroBucketCard({
  ...
  return (
    ...
    >
      ...
      {/* v3.16: images route through /img/v1 (same-origin Worker proxy with
          CORP header); crossOrigin="anonymous" kept as a no-op safety net
          for any non-proxied URL that slips through. */}
      {photoUrl ? (
        <img
          src={photoUrl}
